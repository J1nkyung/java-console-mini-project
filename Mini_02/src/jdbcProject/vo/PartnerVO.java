...
public class PartnerVO {
	...
	public PartnerVO(String memId, String parName, String parSex, String parRegdate){
		this.memId = memId;
	...
	public PartnerVO(String memId, String parName, String parRegnum, String parSex, String parRegdate){
		this.memId = memId;
		this.parName = parName;
	...
	public PartnerVO(String memId, String parRegdate){
		this.memId = memId;
		this.parRegdate = parRegdate;
	}
