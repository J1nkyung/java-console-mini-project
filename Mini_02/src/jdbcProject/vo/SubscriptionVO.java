...
public class SubscriptionVO {
	...
	public SubscriptionVO(String memId, int subDeposit, int subCount) {
		this.memId = memId;
		this.subDeposit = subDeposit;
		this.subCount = subCount;
	}

	public SubscriptionVO(String subNum, String memId, String subDate, int subDeposit, int subCount) {
		this.subNum = subNum;
		this.memId = memId;
