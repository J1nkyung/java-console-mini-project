...
import jdbcProject.vo.ApplicationVO;
import jdbcProject.vo.FamilyVO;
import jdbcProject.vo.HouseVO;
import jdbcProject.vo.MemberVO;
import jdbcProject.vo.PartnerVO;
...
public class MemberDAO {
	...
	public void updateMyinfo(MemberVO member, ApplicationVO app) {
		...
		try {
			...
			//객체의 정보를 가져와서 데이터베이스에 전달하여 업데이트 
			...
			pstmt2.setString(1, app.getMemName());		//해당 멤버의 이름이 app 테이블에도 있으면 update 
